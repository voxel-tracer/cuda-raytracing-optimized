...
__device__ bool scatter_metal(const vec3& albedo, float fuzz, const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered, curandStatePhilox4_32_10_t* local_rand_state) {
...
__device__ bool scatter_dielectric(float ref_idx, const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered, curandStatePhilox4_32_10_t* local_rand_state) {
    vec3 outward_normal;
